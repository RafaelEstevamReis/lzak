...
namespace HostApp.Tests.GCodeTests
{
    public class GCodeGeneratorTests
    {
        ...
        public void GCodeTeste_Empty()
        {
            ...
            var gcode = new GCODETool(new Config()).ToGCODE(map);
...
", gcode);
        ...
        public void GCodeTeste_BoxZMode()
        {
            ...
            var gcode = new GCODETool(new Config() 
...
", gcode);
        ...
        public void GCodeTeste_HalfBoxLaserMode()
        {
            ...
            // 2 => de meio em meio mm
            var gcode = new GCODETool(new Config() { PointsPerMM = 1 })
            .ToGCODE(map);
...
", gcode);
        ...
        {
            GCODETool p = new GCODETool(new Config());
