...
namespace ControllerApp.Core
{
    public class MotorInterface
    {
        ...
        public void Move_Steps(int X, int Y)
        {
            ...
            var moveHaltToken = new CancellationTokenSource();
            Task.Run(() => RuntimeResources.KeyboardListen(Memory, moveHaltToken.Token));
            ...
            while (currentX != X || currentY != Y)
            {
                ...
                if(Memory.HaltKeyPressed) break;
            ...
            // kill keyboard listen thread and its minions
            moveHaltToken.Cancel();
            moveHaltToken.Dispose();
